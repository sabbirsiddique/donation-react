...
const Donations = () => {
  ...
  return (
    <div>
      {notFound ? (
        <div className="flex justify-center items-center text-center bg-red-500 h-[500px] w-[500px] mx-auto text-2xl text-white font-extrabold mt-36 rounded-full">
          <p>{notFound}</p>
        </div>
      ) : (
        <div>
          ...
          {donations.length >= 4 && (
            <button
              ...
              className="px-2 rounded-md text-white font-bold  bg-green-500 block mx-auto"
            >
              {isShow ? "" : "See More"}
            </button>
          )}
